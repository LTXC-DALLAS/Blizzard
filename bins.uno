...
/***************************/
 ...
 __Bin F_FUNC_ATPG_VMIN {
    __Number = 296;
    __Result = __False;
    __CheckOverFlow = __True;
    __Color = 2;
}
 __Bin F_FUNC_PDELAY_VMIN {
    __Number = 297;
    __Result = __False;
    __CheckOverFlow = __True;
    __Color = 2;
}
 __Bin F_FUNC_RAM_VMIN {
    __Number = 298;
    __Result = __False;
    __CheckOverFlow = __True;
    __Color = 2;
}
 __Bin F_FUNC_SRCH_PRE {
    __Number = 299;
    __Result = __False;
    __CheckOverFlow = __True;
    __Color = 2;
}
 __Bin F_FUNC_FSRCH_PRE {
    __Number = 300;
    __Result = __False;
    __CheckOverFlow = __True;
    __Color = 2;
 ...
 __Bin F_FUNC_ATPG_VBOXHI {
    __Number = 302;
    __Result = __False;
    __CheckOverFlow = __True;
    __Color = 2;
}
 __Bin F_FUNC_RAM_VBOXHI {
    __Number = 303;
    __Result = __False;
    __CheckOverFlow = __True;
    __Color = 2;
}
 __Bin F_FUNC_FSRCH_PST {
    __Number = 304;
    __Result = __False;
    __CheckOverFlow = __True;
    __Color = 2;
}
 __Bin F_LEAK_IDDQ_POST {
    __Number = 305;
    __Result = __False;
    __CheckOverFlow = __True;
    __Color = 2;
 ...
 __Bin F_FUNC_ATPG_VMAX {
    __Number = 307;
    __Result = __False;
    __CheckOverFlow = __True;
    __Color = 2;
}
 __Bin F_FUNC_RAM_VMAX {
    __Number = 308;
    __Result = __False;
    __CheckOverFlow = __True;
    __Color = 2;
}
 __Bin F_FUNC_ATPG_VBOXLO {
    __Number = 309;
    __Result = __False;
    __CheckOverFlow = __True;
    __Color = 2;
}
 __Bin F_FUNC_RAM_VBOXLO {
    __Number = 310;
    __Result = __False;
    __CheckOverFlow = __True;
    __Color = 2;
