...
Pattern wdtimer0_reset_pll_v23_CPM {
...
Default WaveformTable WFT26;

" Processed by Jazz::Tvt::tvtFusion version 1.199.0, updated Nov 22, 2011 "
" TDL:  TDLS/wdtimer0_reset_pll_v23.tdl.gz "
" Generated:  Wed Dec 28 17:58:11 US/Central 2011 "
...
"           PATTERN_SET_NAME = wdtimer0_reset_pll_v23, "
...
"                                                                                                              2                 "
*/
$wdtimer0_reset_pll_v23_CPM_st
*-----------------------------------------------------------------------------------<--------------------------------------------*;<SWCCPM>
*-----------------------------------------------------------------------------------<--------------------------------------------*;<LDA wdtimer0_reset_pll_v23_DPM_st,COND NZC2>
*-----------------------------------------------------------------------------------<--------------------------------------------*;<RPT 128>
...
*MMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMLLLMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMLMLMMMMMMMMMMMMMH<MMMMMMLMMMMMMMMMMMLLLMMMMMMMMMMMMMMMMMLMMMMM*; <CJMP wdtimer0_reset_pll_v23_match1,DC2>
...
*MMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMLLLMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMLMLMMMMMMMMMMMMMH<MMMMMMLMMMMMMMMMMMLLLMMMMMMMMMMMMMMMMMLMMMMM*; <JMP wdtimer0_reset_pll_v23_continue1> "passing sites continue execution"
"match block"
$wdtimer0_reset_pll_v23_match1
...
*MMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMLLLMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMLMLMMMMMMMMMMMMMH<MMMMMMLMMMMMMMMMMMLLLMMMMMMMMMMMMMMMMMLMMMMM*; <CJMP wdtimer0_reset_pll_v23_loop1>
$wdtimer0_reset_pll_v23_continue1
...
$wdtimer0_reset_pll_v23_CPM_end
