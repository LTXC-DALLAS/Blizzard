...
Pattern wdtimer1_reset_pll_v23_CPM {
...
" TDL:  TDLS/wdtimer1_reset_pll_v23.tdl.gz "
...
"           PATTERN_SET_NAME = wdtimer1_reset_pll_v23, "
...
"                                                                                                              2                 "
*/
$wdtimer1_reset_pll_v23_CPM_st
*-----------------------------------------------------------------------------------<--------------------------------------------*;<SWCCPM>
*-----------------------------------------------------------------------------------<--------------------------------------------*;<LDA wdtimer1_reset_pll_v23_DPM_st,COND NZC2>
*-----------------------------------------------------------------------------------<--------------------------------------------*;<RPT 128>
...
*MMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMLLLMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMLMLMMMMMMMMMMMMMH<MMMMMMLMMMMMMMMMMMLLLMMMMMMMMMMMMMMMMMLMMMMM*; <CJMP wdtimer1_reset_pll_v23_match1,DC2>
...
*MMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMLLLMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMLMLMMMMMMMMMMMMMH<MMMMMMLMMMMMMMMMMMLLLMMMMMMMMMMMMMMMMMLMMMMM*; <JMP wdtimer1_reset_pll_v23_continue1> "passing sites continue execution"
"match block"
$wdtimer1_reset_pll_v23_match1
...
*MMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMLLLMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMLMLMMMMMMMMMMMMMH<MMMMMMLMMMMMMMMMMMLLLMMMMMMMMMMMMMMMMMLMMMMM*; <CJMP wdtimer1_reset_pll_v23_loop1>
$wdtimer1_reset_pll_v23_continue1
...
$wdtimer1_reset_pll_v23_CPM_end
